...
public class LeftHeroesBox extends VBox {
    public LeftHeroesBox() {
        super(10);
        ...
        for (int i = 0; i < 2; i++) col1.getChildren().add(new BaseCardView(new Minion()));

        VBox col2 = new VBox(10);
        col2.setAlignment(Pos.CENTER);
        for (int i = 0; i < 3; i++) col2.getChildren().add(new BaseCardView(new Minion()));
